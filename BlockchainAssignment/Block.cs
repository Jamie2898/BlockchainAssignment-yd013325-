...
namespace BlockchainAssignment
{
    class Block
    {
        ...
        /// <summary>
        /// Mine() that executes the CreateHash() method within a while loop, 
        ...
        /// <summary>
        /// Override ToString() to return a list view
        /// </summary>
        /// <returns></returns>
